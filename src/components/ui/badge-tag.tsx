...
export default function BadgeTag() {
    return (
        <div className="inline-flex items-center gap-2 border border-white/10 bg-white/5 backdrop-blur-md rounded-full pl-2 pr-3 py-1 text-[12px] sm:text-[13px] animate-fade-in mb-6">
            <span className="flex items-center gap-1.5 text-primary font-medium">
                ...
                Built systems across healthcare, procurement intelligence, and enterprise knowledge workflows.
            </span>
            <span className="text-white/20 text-base">•</span>
            <a href="#projects" className="flex items-center gap-1 text-white/60 hover:text-white transition-colors duration-200">
                Learn more
